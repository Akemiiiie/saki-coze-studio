...
type user struct {
	...
	CreatedAt    field.Time  // Creation Time (Milliseconds)
	UpdatedAt    field.Time  // Update Time (Milliseconds)
	DeletedAt    field.Time  // Deletion Time (Milliseconds)
