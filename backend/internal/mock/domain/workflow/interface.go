...
func (m *MockService) GetLatestNodeDebugInput(ctx context.Context, wfID int64, nodeID string, userID int) (*entity.NodeExecution, *entity.NodeExecution, bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) GetLatestTestRunInput(ctx context.Context, wfID, userID int) (*entity.NodeExecution, bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) GetTestRunLatestExeID(ctx context.Context, wfID int64, uID int64) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) SetNodeDebugLatestExeID(ctx context.Context, wfID int64, nodeID string, uID int64, exeID int64) error {
	m.ctrl.T.Helper()
...
func (m *MockRepository) SetTestRunLatestExeID(ctx context.Context, wfID int64, uID int64, exeID int64) error {
	m.ctrl.T.Helper()
