...
type BotInfo struct {
	...
	// create_time
	CreateTime time.Time `thrift:"CreateTime,7" form:"create_time" json:"create_time,string"`
	// update time
	UpdateTime time.Time `thrift:"UpdateTime,8" form:"update_time" json:"update_time,string"`
	// line of business
...
func (p *BotInfo) GetCreateTime() (v time.Time) {
	return p.CreateTime
}

func (p *BotInfo) GetUpdateTime() (v time.Time) {
	return p.UpdateTime
}
...
func (p *BotInfo) ReadField7(iprot thrift.TProtocol) error {
	var _field time.Time
	if v, err := iprot.ReadI64(); err != nil {
		return err
	} else {
		_field = time.UnixMilli(v)
	}
	p.CreateTime = _field
	return nil
}
...
func (p *BotInfo) writeField6(oprot thrift.TProtocol) (err error) {
	...
	if err := oprot.WriteI64(int64(p.CreatorId)); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *BotInfo) writeField7(oprot thrift.TProtocol) (err error) {
	...
	if err := oprot.WriteI64(p.CreateTime.UnixMilli()); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *BotInfo) writeField8(oprot thrift.TProtocol) (err error) {
	...
	if err := oprot.WriteI64(p.UpdateTime.UnixMilli()); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
