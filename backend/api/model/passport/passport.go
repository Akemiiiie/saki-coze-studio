...
type User struct {
	...
	UserIDStr      int        `thrift:"user_id_str,1,required" form:"user_id_str,required" json:"user_id_str,string,required" query:"user_id_str,required"`
...
func (p *User) GetUserIDStr() (v int) {
	return p.UserIDStr
}
...
func (p *User) writeField1(oprot thrift.TProtocol) (err error) {
	...
	if err := oprot.WriteI64(int64(p.UserIDStr)); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
